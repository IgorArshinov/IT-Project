...
@Component({
  selector: 'app-trueorfalse-video',
  templateUrl: './trueorfalse-video.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class TrueorfalseVideoComponent implements OnInit {
  ...
  submit(aspects) {
    this.exercise.emit({
      ...aspects,
      type: "True or false video",
      questionUrl: this.questionUrl,
      videoUrl: this.form.get('video').value,
